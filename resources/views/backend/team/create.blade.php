                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="summary" id="teams" rows="3"></textarea>
                      </div>

                      <div class="mb-3">
                        <label for="inputProductDescription" class="form-label">Experience</label>
                        <textarea class="form-control" name="exp" id="exp" rows="3"></textarea>
                      </div>
                      <div class="mb-3">
                    ...
                    <div class="border border-3 p-4 rounded">
                      <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="education" id="inputStarPoints" placeholder="education">
                          </div>

                        <div class="col-md-12">
                            <label for="inputStarPoints" class="form-label">Specialization</label>
                            <input type="text" class="form-control" name="spec" id="inputStarPoints" placeholder="spec">
                          </div>

                          <div class="col-12">
                            <label for="inputProductTags" class="form-label">Skill</label>
                            <input type="text" class="form-control" name="skills" id="inputProductTags" placeholder="skill">
                          </div>
                        <div class="col-md-12">
                            <label for="inputPrice" class="form-label">Email</label>
                            <input type="email" class="form-control" name="email" id="inputPrice" placeholder="email">
                          </div>
                          <div class="col-md-12">
                            <label for="inputCompareatprice" class="form-label">Address</label>
                            <input type="text" class="form-control" name="address" id="inputCompareatprice" placeholder="address">
                          </div>
                          <div class="col-md-12">
                            <label for="inputCostPerPrice" class="form-label">Phone Number</label>
                            <input type="number" name="phone" class="form-control" id="inputCostPerPrice" placeholder="number">
                          </div>
                      </div>
                  </div>
                  </div>

               ...
               <div class="form-body mt-4">
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        <label for="inputProductDescription" class="form-label"> Body</label>
                         <textarea class="form-control" name="text_en" id="sliders" rows="3">{{ $slider->text_en }}</textarea>
                        </div>
                   </div>
                   <div class="col-12">
                    <label for="inputProductType" class="form-label">Slider </label>
                    <select class="form-select"  name="position_id" id="inputProductType">
                        <option value=""></option>
                  ...
                  <div class="mb-3">
                    ...
                    <input id="image-uploadify" type="file" value="{{$slider->image}}" name="image" accept=".xlsx,.xls,image/*,.doc,audio/*,.docx,video/*,.ppt,.pptx,.txt,.pdf" multiple>

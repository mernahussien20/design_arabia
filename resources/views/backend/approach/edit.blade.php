    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Approach </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
          <div class="card-body p-4">
              <h5 class="card-title">Add New Approach</h5>
              <hr/>
               ...
               <div class="form-body mt-4">
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        <label for="inputProductTitle"  class="form-label">Approach Title</label>
                        <input type="text" class="form-control" value="{{ $approach->title }}" name="title" id="inputProductTitle" placeholder="approach name">
                      </div>
                    <div class="mb-3">
                        <label for="inputProductDescription" class="form-label"> Body</label>
                         <textarea class="form-control" name="body" id="sliders" rows="3">{{ $approach->body }}</textarea>
                        </div>
                   </div>

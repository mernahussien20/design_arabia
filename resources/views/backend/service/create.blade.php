                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="inputProductDescription" class="form-label"> Body</label>
                         ...
                         <textarea class="form-control" name="body" id="sliders" rows="3"></textarea>
                      </div>
                       ...
                       <div class="col-6">
                           ...
                           <div class="imageuploadify well">
                               ...
                               <div class="imageuploadify-images-list text-center">
                                   ...
                                   <div id="imagepre" class="imageuploadify-details" style="opacity: 0;"><img id="blah" src="#" alt="Your File(s)Here"></div>
                               </div>
                           </div>
                       </div>

                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name_en" value="{{$category->name_en}}" id="inputProductTitle" placeholder="category name">
                      </div>
                       <div class="mb-3">
                           <label for="inputProductDescription" class="form-label"> Body</label>
                           <textarea class="form-control" name="text" id="sliders" rows="3">{{ $category->text }}</textarea>
                       </div>
                   </div>
                      ...
                      <div class="mb-3">
                        ...
                        <img src="{{url('public/services/' . $category->image) }}" width="50" height="50" alt="">
                      </div>
                    </div>
                   </div>

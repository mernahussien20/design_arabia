        ...
        <div class="card">
          <div class="card-body p-4">
              ...
              @if ($errors->any())
               ...
               @endif
             <form action="{{ route('FaqQuestion.store') }}" method="post" enctype="multipart/form-data">
               @csrf
                  ...
                  <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="question" id="inputProductTitle" placeholder="question">
                      </div>

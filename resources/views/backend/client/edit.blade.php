                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $client->link }}" name="link" id="inputProductTitle" placeholder="link">
                      </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input id="image-uploadify" type="file" value="{{$client->image}}" name="image" accept=".xlsx,.xls,image/*,.doc,audio/*,.docx,video/*,.ppt,.pptx,.txt,.pdf" multiple>

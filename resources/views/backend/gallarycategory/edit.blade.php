...
@section('title' , 'Edit Gallary Category  ')
@section('content')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
          ...
          @endif
          <form action="{{ route('GallaryCategory.update', $category->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $category->name }}" name="name" id="inputProductTitle" placeholder="category name">
                      </div>

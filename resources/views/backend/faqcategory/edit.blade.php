...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
          ...
          @endif
          <form action="{{ route('FaqCategory.update', $faq->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $faq->name }}" name="name" id="inputProductTitle" placeholder=" Faq category name">
                      </div>

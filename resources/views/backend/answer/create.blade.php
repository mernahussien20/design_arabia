    ...
    <div class="page-content">
        ...
        <div class="card">
          <div class="card-body p-4">
              <h5 class="card-title">Add New Faq Answer </h5>
              <hr/>
                  ...
                  <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="answer" id="inputProductTitle" placeholder="answer">
                      </div>


                         <div class="col-12">
                            <label for="inputProductType" class="form-label">Faq Question</label>

                            <select class="form-select"  name="question_id" id="inputProductType">

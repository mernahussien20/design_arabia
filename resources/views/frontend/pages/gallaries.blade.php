...
{{--                            <a  href="{{ route('Services', $serv->id) }}">--}}

{{--                                <div class="ori-service-page-service-inner-item">--}}


{{--                                    <div class="service-text pera-content tren">--}}
                    ...
                    @foreach($services_cat as $serv)
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <div class="ori-blog-inner-item">
                                <a  href="{{ route('gallary.show', $serv->id) }}">
                                    ...
                                    <div class="blog-inner-text">
                                        <h3><a href="{{ route('gallary.show', $serv->id) }}">{{$serv->name_en}}</a></h3>
                                        {{-- <p>{!! $serv->text !!} </p>--}}
                                    </div>
                                </a>
                            </div>
